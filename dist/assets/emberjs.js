...
;define("emberjs/app", ["exports", "ember-resolver", "ember-load-initializers", "emberjs/config/environment"], function (_exports, _emberResolver, _emberLoadInitializers, _environment) {
  "use strict";
...
;define("emberjs/helpers/app-version", ["exports", "emberjs/config/environment", "ember-cli-app-version/utils/regexp"], function (_exports, _environment, _regexp) {
  "use strict";
...
;define("emberjs/helpers/pluralize", ["exports", "ember-inflector/lib/helpers/pluralize"], function (_exports, _pluralize) {
  "use strict";
...
;define("emberjs/initializers/export-application-global", ["exports", "emberjs/config/environment"], function (_exports, _environment) {
  "use strict";
...
;define("emberjs/router", ["exports", "emberjs/config/environment"], function (_exports, _environment) {
  "use strict";
...
;define("emberjs/templates/application", ["exports"], function (_exports) {
  "use strict";
...
;
          if (!runningTests) {
            require("emberjs/app")["default"].create({"name":"emberjs","version":"0.0.0+aa00ae90"});
          }
